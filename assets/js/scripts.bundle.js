        ...
        */
        alert: function(options) {
            ...
            if (!options.container) {
                if ($('.page-fixed-app-content').size() === 1) {
                    $('.page-fixed-app-content').prepend(html);
...
var mUtil = function() {
    ...
    */
    ...
    return {
        ...
        * @returns null
        */
        //app function to initiate the theme
...
(function($) {
	...
	$.fn.mDatatable = function(options) {
		...
		var Plugin = {
			...
			setupBaseDOM: function() {
				...
				if ($(datatable).prop('tagName') === 'TABLE') {
					// if app init element is <table>, wrap with div
		...
		// initialize app datatable plugin
