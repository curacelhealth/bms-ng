    ...
    vm.dtColumns = [
        ...
        DTColumnBuilder.newColumn(null).withTitle('Actions').notSortable()
            .renderWith(function(data, type, full, meta) {
                ...
                return '<a ui-sref="hmo.providersView({id:'+full.id+'})" class="btn btn-primary" style="border-radius: 50px; width:75px" title="View details"><i class="fa fa-binoculars"></i> View</a><br>'+
                	   '<a ui-sref="hmo.providersEdit({id:'+full.id+'})" class="btn btn-primary" style="border-radius: 50px; width:75px" title="Edit details"><i class="fa fa-edit"></i> Edit</a>'
            }),
    ];
