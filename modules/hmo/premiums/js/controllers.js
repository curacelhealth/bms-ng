...
angular.module('BmsApp')
    .controller('HmoPremiumListCtrl', function($scope,$compile,$activityIndicator,EnrolleeService,$state,DTColumnBuilder,DTOptionsBuilder,UserService) {
...
.controller('HmoPremiumCreateCtrl', function($scope,$activityIndicator,UserService,$state,CompaniesService,EnrolleeService,OptionService) {
    $scope.enrollee = {
        type:'P'
    }
